...
const Home = () => {
  ...
  return (
    <PrimaryLayout>
      ...
      <Meta
        title="At SJCE-STEP, we offer a range of programs designed to support innovation and entrepreneurship."
        description="At SJCE-STEP, we offer a range of programs designed to support innovation and entrepreneurship. Our flagship programs include NIDHI Prayas, SISFS, and acceleropreneur"
        keywords="Innovation, Incubation Opportunities"
        ogTitle="At SJCE-STEP, we offer a range of programs designed to support innovation and entrepreneurship."
        ogDescription="At SJCE-STEP, we offer a range of programs designed to support innovation and entrepreneurship. Our flagship programs include NIDHI Prayas, SISFS, and acceleropreneur"
        ogUrl="https://www.sjcestep.in/"
        twitterTitle="At SJCE-STEP, we offer a range of programs designed to support innovation and entrepreneurship."
        twitterDescription="At SJCE-STEP, we offer a range of programs designed to support innovation and entrepreneurship. Our flagship programs include NIDHI Prayas, SISFS, and acceleropreneur"
      />
      {isLoading ? (
        <DataLoader />
      ) : (
